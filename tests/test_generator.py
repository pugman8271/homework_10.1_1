...
def test_filter_by_currency(transactions):
    ...
    assert {transaction["date"] for transaction in usd_transactions_list} == {
    ...
    assert {transaction["id"] for transaction in rub_transactions_list} == {
        873106923,
        594226727,
    }
...
def test_card_number_generator(start, stop, expected):
    ...
    assert list(card_number_generator(10000000000, 10000000000)) == [
        "0000 0100 0000 0000"
    ]
